...
class CashboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cashbox" do
    assert_difference('Cashbox.count') do
      post cashboxes_url, params: { cashbox: { accounting_date: @cashbox.accounting_date, active: @cashbox.active, month: @cashbox.month, name: @cashbox.name, year: @cashbox.year } }
    end
  ...
  test "should update cashbox" do
    patch cashbox_url(@cashbox), params: { cashbox: { accounting_date: @cashbox.accounting_date, active: @cashbox.active, month: @cashbox.month, name: @cashbox.name, year: @cashbox.year } }
